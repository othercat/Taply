...
- [x] MIDI / XG support 是可选后续功能，不得阻塞 base port；第一版只需支持 M1 Pro macOS 15.0+。  ✅ 2026-05-11
...
- [x] **Step 1：记录 Windows 参考听音链路  ✅ 2026-05-11**
...
- [x] **Step 2：新增 MIDI 文件类型  ✅ 2026-05-11**
...
- [x] **Step 3：选择第一版 macOS MIDI backend  ✅ 2026-05-11**
...
- [x] **Step 4：新增 `MIDISoundFilePlayer`  ✅ 2026-05-11**
...
- [x] **Step 6：新增 sound bank 配置路径  ✅ 2026-05-11**
...
- [x] **Step 7：新增 MIDI / XG 测试文档  ✅ 2026-05-11**
...
- [x] Phase 5 实现后，可选 MIDI preview 能在 Apple Silicon macOS 15+ 打开并 loop `.mid` 文件。  ✅ 2026-05-11
- [x] MIDI 文档明确区分 macOS preview playback 与 Windows S-YXG50 parity validation。  ✅ 2026-05-11
